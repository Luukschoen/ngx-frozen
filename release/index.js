...
var BarVerticalComponent = (function (_super) {
    ...
    BarVerticalComponent.prototype.getYDomain = function () {
        ...
        var max = this.yAxisMinScale
            ? Math.max.apply(Math, [this.yAxisMinScale].concat(values)) : Math.max.apply(Math, values);
        return [min, max];
    };
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Number)
], BarVerticalComponent.prototype, "minimumDeviation", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Boolean)
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Boolean)
], BarVerticalComponent.prototype, "showRefLines", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BarVerticalComponent.prototype, "referenceLines", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Boolean)
...
var SeriesVerticalComponent = (function () {
    ...
    SeriesVerticalComponent.prototype.update = function () {
        ...
        this.bars = this.series.map(function (d, index) {
            ...
            if (_this.type === 'standard') {
                bar.height = Math.abs(_this.dims.height - _this.yScale(value));
...
var LineChartComponent = (function (_super) {
    ...
    LineChartComponent.prototype.getYDomain = function () {
        ...
        var max = this.yScaleMin
            ? Math.max.apply(Math, [this.yScaleMin].concat(domain)) : Math.max.apply(Math, domain);
        return [min, max];
    };
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Number)
], LineChartComponent.prototype, "minimumDeviation", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
